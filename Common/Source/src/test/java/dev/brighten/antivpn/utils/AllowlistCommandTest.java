...
class AllowlistCommandTest {
  ...
  private static final UUID FUNKEMUNKY_UUID =
      UUID.fromString("123e4567-e89b-12d3-a456-426614174000");

  @Mock private AntiVPN antiVPN;

  @Mock private VPNConfig vpnConfig;

  @Mock private VPNDatabase database;

  @Mock private dev.brighten.antivpn.api.PlayerExecutor playerExecutor;
