...
abstract class DatabaseIntegrationTestSupport {
  ...
  @Mock protected AntiVPN antiVPN;

  @Mock protected VPNConfig vpnConfig;
  ...
  private Optional<VPNResponse> awaitStoredResponse(VPNDatabase database, String ip)
  ...
  protected void awaitCondition(CheckedBooleanSupplier condition, String failureMessage)
      throws InterruptedException {
