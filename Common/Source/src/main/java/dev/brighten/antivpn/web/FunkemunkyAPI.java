...
public class FunkemunkyAPI {
   ...
   * @throws IOException Throws when there is an error connecting to and processing information from
   *     API.
   */
  public static VPNResponse getVPNResponse(
  ...
  /**
   * Feeds into {@link FunkemunkyAPI#getQueryResponse(String)} using "none" as argument to grab
   * query information based on the connecting IP address.
   *
  ...
  /**
   * Queries <a href="https://funkemunky.cc/vpn/queryCheck">...</a> and returns information based on
   * the provided licence input.
   *
   * @param license String
   * @return QueryResponse
   * @throws JSONException Throws when JSON response is not formatted properly.
