...
/**
 * Used to format the JSON response from <a href="https://funkemunky.cc/vpn/queryCheck">...</a> into
...
public class QueryResponse {
  ...
  /**
   * Formats response from <a href="https://funkemunky.cc/vpn/queryCheck">...</a> into {@link
  ...
  public static QueryResponse fromJson(JSONObject object) throws JSONException {
    ...
    return QueryResponse.builder()
        ...
        .queriesMax(object.getLong("queryLimit"))
        .build();
  }
}
